 ...
 */
package eu.dissco.core.digitalmediaobjectprocessor.database.jooq.tables.records;
...
public class NewDigitalMediaObjectRecord extends UpdatableRecordImpl<NewDigitalMediaObjectRecord> implements Record13<String, Integer, String, String, String, String, String, Instant, Instant, Instant, JSONB, JSONB, String> {
    ...
    /**
     * Setter for <code>public.new_digital_media_object.physical_specimen_id</code>.
     */
    ...
    /**
     * Getter for <code>public.new_digital_media_object.physical_specimen_id</code>.
     */
    ...
    @Override
    public Row13<String, Integer, String, String, String, String, String, Instant, Instant, Instant, JSONB, JSONB, String> valuesRow() {
    ...
    public Field<String> field13() {
        return NewDigitalMediaObject.NEW_DIGITAL_MEDIA_OBJECT.PHYSICAL_SPECIMEN_ID;
    }
    ...
    @Override
    public NewDigitalMediaObjectRecord value13(String value) {
        setPhysicalSpecimenId(value);
        return this;
    }

    @Override
    public NewDigitalMediaObjectRecord values(String value1, Integer value2, String value3, String value4, String value5, String value6, String value7, Instant value8, Instant value9, Instant value10, JSONB value11, JSONB value12, String value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NewDigitalMediaObjectRecord(String id, Integer version, String type, String digitalSpecimenId, String mediaUrl, String format, String sourceSystemId, Instant created, Instant lastChecked, Instant deleted, JSONB data, JSONB originalData, String physicalSpecimenId) {
        super(NewDigitalMediaObject.NEW_DIGITAL_MEDIA_OBJECT);
